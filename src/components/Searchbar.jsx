...
const Searchbar = () => {
    ...
    return (
        ...
        <div className='ml-auto mr-auto h-64 addwidth'>
            ...
            <div className=' mt-10 flex items-center bg-white h-28 w-full rounded-lg text-neutral-400 '>
...
<div className='border-solid border-2 border-neutral-300 h-16'></div>
            ...
            {handleSearch().map((item)=>(
                ...
                <Card  price={item.price} imgs={item.img} property={item.property} address={item.address} bed={item.bed} bath={item.bath} area={item.area} />
